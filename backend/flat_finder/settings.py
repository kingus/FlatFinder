"""
Django settings for flat_finder project.
...
WSGI_APPLICATION = 'flat_finder.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get('EMAIL_ADDRESS_TEST')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_PASS_TEST')
